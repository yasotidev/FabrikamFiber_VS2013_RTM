   ...
   public class ServiceTicket
   {
      ...
      public string TimeOpen
      {
         get
         {
            ...
            if (span.Days > 0) { return string.Format("{0} Days", span.Days); }

            if (span.Hours > 0) { return string.Format("{0} Hours", span.Hours); }

            if (span.Minutes > 0) { return string.Format("{0} Minutes", span.Minutes); }
