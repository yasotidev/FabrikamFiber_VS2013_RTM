...
namespace FabrikamFiber.Web.Tests.Controllers
{
   ...
   public class ServiceTicketsControllerTest
   {
      ...
      private ServiceTicketsController controller;
      private DynamicMock mockCustomerRepo;
      private DynamicMock mockEmployeeRepo;
      private DynamicMock mockLogEntryRepo;
      private DynamicMock mockScheduleItemRepo;
      private DynamicMock mockServiceTicketRepo;
      ...
      public void ScheduleActionReturnsValidViewModel()
      {
         ...
         // Arrange
         mockServiceTicketRepo.SetReturnValue(
            "FindIncluding",
            new ServiceTicket
            {
               ID = 1
            });
         mockEmployeeRepo.SetReturnValue(
            "Find",
            new Employee
            {
               ID = 1
