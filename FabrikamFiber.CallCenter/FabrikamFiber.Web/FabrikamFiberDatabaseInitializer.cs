...
namespace FabrikamFiber.Web
{
   ...
   public class FabrikamFiberDatabaseInitializer : DropCreateDatabaseIfModelChanges<FabrikamFiberWebContext>
   {
      ...
      protected override void Seed(FabrikamFiberWebContext context)
      {
         ...
         var serviceTicket = context.ServiceTickets.Add(
            new ServiceTicket
            {
         ...
         context.ScheduleItems.Add(
            new ScheduleItem
            {
               ...
               Start =
                  DateTime.ParseExact(
                     "Mon 16 May 8:00 AM 2011",
                     "ddd dd MMM h:mm tt yyyy",
                     CultureInfo.InvariantCulture),
               WorkHours = 1
            });

         context.ServiceLogEntries.Add(
            new ServiceLogEntry
            {
         ...
         serviceTicket = context.ServiceTickets.Add(
            new ServiceTicket
            {
